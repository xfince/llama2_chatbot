...
st.set_page_config(page_title="LLaMA2 Chatbot for Travel GUide", page_icon="🦙", layout="wide")
...
def render_app():
    ...
    st.sidebar.write(" ")
    st.sidebar.markdown("*Made by Vincent. Not associated with Meta Platforms, Inc.*")
    ...
    # Accept user input
    if prompt := st.chat_input("Hello am LLaMA2 talk to me about travel."):
